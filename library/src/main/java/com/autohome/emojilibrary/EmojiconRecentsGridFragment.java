...
import com.autohome.emojilibrary.manager.EmojiconRecentsManager;
...
public class EmojiconRecentsGridFragment extends EmojiconGridFragment implements EmojiconRecents {
    private ArrayAdapter<Emojicon> mAdapter;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mAdapter = new ExpressAdapter(view.getContext(), R.layout.emojicon_item, R.id.emojicon_icon, recents, null);
